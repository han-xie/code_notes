...
* REFERENCE: https://computing.llnl.gov/tutorials/pthreads/samples/hello_arg2.c
* - https://computing.llnl.gov/tutorials/pthreads/ (accessed Mar. 13, 2019)
*   I put it in my github for learning purpose only, please refer to the link
*   above for the original information.
* COMPILATION: gcc -pthread -o 11_pthread_arg 11_pthread_arg.c
* FILE: 11_pthread_arg.c
* DESCRIPTION:
